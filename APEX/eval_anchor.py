...
from APEX.mm_utils import tokenizer_image_audio_video_token
from APEX.model.all_builder import load_all_pretrained_model
from APEX.constants import IGNORE_INDEX
import zipfile
from PIL import Image
import copy

# Import shared classes and functions from train/data.py
from APEX.eval import make_supervised_data_module, args, preprocess, rank0_print, extract_image_from_zip
from APEX.train.data import ModelArguments as BaseModelArguments
...
def eval_anchor(margs):
    ...
    # 创建锚点模型实例
    print("正在创建锚点模型...")
    from APEX.model.language_model.llava_llama_anchor import LlavaLlamaAnchorForCausalLM
        ...
        with torch.no_grad():
            ...
            if model_args.use_anchor_mode:
                ...
                try:
                    ...
                    raise
                print("预计算专家选择...")
                from APEX.model.moe.moe import precompute_expert_selection, AnchorMoeLayer
